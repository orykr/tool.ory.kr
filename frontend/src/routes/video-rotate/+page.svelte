...
<GifTool title="Video Rotator" description="Rotate or flip a video and re-encode to MP4." accept="video/*" dropLabel="Click or drag & drop a video here" downloadName="rotated.mp4" outputMime="video/mp4" actionLabel="Rotate" buildArgs={build}>
	{#snippet settings()}
