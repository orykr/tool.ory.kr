...
export const categories: ToolCategory[] = [
	...
	},
	{
		...
		tools: [
			...
			{ href: "/video-to-gif", title: "Video to GIF", description: "Convert video files (MP4, WebM, MOV, AVI, MKV) to optimized animated GIFs directly in your browser." },
			{ href: "/mp4-to-gif", title: "MP4 to GIF", description: "Alias for Video to GIF — drop an MP4 to convert to GIF." },
